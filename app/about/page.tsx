      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-4xl mx-auto leading-relaxed">
            &ldquo;เราตั้งใจที่จะสร้างสรรค์ผลิตภัณฑ์ผ้าคลุมโซฟาคุณภาพสูงที่ตอบโจทย์ความต้องการ ของลูกค้าในทุกไลฟ์สไตล์ พร้อมมอบประสบการณ์การช้อปปิ้งที่ดีที่สุด
            และบริการหลังการขายที่เป็นเลิศ เพื่อให้ทุกบ้านมีความสุขและความสวยงาม ที่ยั่งยืน&rdquo;
          </p>
        </div>
      </section>
